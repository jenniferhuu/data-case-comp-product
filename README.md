...
View modes — All (global overview), Single (donor or country focus), Compare (side-by-side analysis).
Selection-driven insights panel — right-hand analysis updates dynamically based on what's selected on the globe.
Flow geography breakdown — cross-border vs. domestic split, currently 77.4% / 22.6%.
Grants vs. Loans split — mode-level portfolio analysis.
Filterable by donor, donor country, recipient country, and sector (Emergency, Health, Education, Climate, Environment, Economic Dev, Gov & Civil Society, Other).
